...
class EuclideanDistanceTest {
    ...
    void calculateDistance() throws IllegalArgumentException {
        ...
        // excepcion
        assertThrows(IllegalArgumentException.class, () -> ecludiana.calculateDistance(parametros1, parametros3), "Debería lanzar IllegalArgumentException si los parámetros son incorrectos");
